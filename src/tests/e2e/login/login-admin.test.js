...
describe('LOGIN ADMIN - E2E', () => {
    ...
    test('debe loguearse correctamente y redireccionar al dashboard admin', async () => {

        const loginUrl = 'http://localhost:5173/iniciar-sesion';

        const testEmail = 'jonier145@gmail.com';
        const testPassword = 'Jonier25@';
        ...
        expect(currentUrl).toContain('/admin/inicio');
    });
});
